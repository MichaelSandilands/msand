...
theme_msand <- function(base_size = 11, base_family = "") {
  ...
  ggplot2::theme_grey(base_size = base_size, base_family = base_family) %+replace%
    ggplot2::theme(
      ...
      line               =  ggplot2::element_line(colour = dark_grey, linewidth = 0.5, linetype = 1,
                                                  lineend = "butt"),
      ...
      axis.ticks         = ggplot2::element_line(color = dark_grey, linewidth = ggplot2::rel(1/3)),
      axis.title         = ggplot2::element_text(size = ggplot2::rel(1.0)),

      # Panel
      panel.background   = ggplot2::element_rect(fill  = white, color = NA),
      panel.border       = ggplot2::element_rect(fill = NA, linewidth = ggplot2::rel(1/2), color = dark_grey),
      panel.grid.major   = ggplot2::element_line(color = ggplot2::alpha(dark_grey, 0.25), linewidth = ggplot2::rel(1/5)),
      panel.grid.minor   = ggplot2::element_line(color = ggplot2::alpha(dark_grey, 0.1), linewidth = ggplot2::rel(1/10)),
