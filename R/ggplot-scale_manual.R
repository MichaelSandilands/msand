...
#' \describe{
#'
#' \item{`scale_colour_msand2`}{
#' For use when `colour` is specified as an `aes()` in a ggplot.}
#'
#' \item{`scale_fill_msand2`}{
#' For use when `fill` is specified as an `aes()` in a ggplot.}
#' }
#'
#' @seealso [theme_msand()]
...
scale_colour_msand2 <- function(...) {
  ggplot2::scale_color_manual(values = unname(palette_msand2()))
}

#' @rdname scale_manual
#' @export
scale_color_msand2 <- scale_colour_msand2

#' @rdname scale_manual
#' @export
scale_fill_msand2 <- function(...) {
  ggplot2::scale_fill_manual(values = unname(palette_msand2()))
}
